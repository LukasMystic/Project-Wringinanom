    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between">
                <a href="{{ route('archive.create') }}" class="btn btn-outline-primary btn-lg">  + Tambah Data </a>

                <form class="d-flex" method="GET" action="{{route('archive.search')}}">
                    @csrf
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-container">
                                    <a href="{{ route('archive.edit', $archive) }}" class="btn btn-warning">
